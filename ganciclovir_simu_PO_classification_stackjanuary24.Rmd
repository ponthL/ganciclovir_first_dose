...
we simulated age, weight, height and creatinine clearance
...
### creatinine clearance simulated 
...
auc_ml_pred_class_train <-
 ...
 #saveRDS(auc_ml_model_st, file = "final_wf_stack_PO_mai2023.rds")
...
dose_search = function(Pds,taille,Clcreat,SEX,greffe,age,amt2=case_when(
  ...
  Clcreat>=150~(sqrt((Pds*taille)/3600)*1050)))
{
